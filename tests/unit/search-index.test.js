...
const sampleData = {
  ...
  bugs: [
    { id: 'BUG-0015', title: 'Auth redirect fails', severity: 'High', status: 'Open' },
  ],
  lessons: [
    { id: 'L-0007', rule: 'Validate tokens', context: 'Security' },
  ],
};

describe('buildSearchIndex', () => {
  let index;
  beforeEach(() => { index = buildSearchIndex(sampleData); });
