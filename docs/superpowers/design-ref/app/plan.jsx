    ...
    <header className="masthead">
      <div className="mh-head">
        <div className="eyebrow">
          {D.project.name} · Release {D.project.release}
        </div>
        <h1 className="mh-title">
          {titles[tab]} <em>report</em>
        </h1>
      </div>
      <div className="mh-meta">
        <div className="item">
          ...
          <span className="val">
            76% <span className="delta up">▲ +6.2</span>
          </span>
        </div>
        <div className="item">
          <span className="eyebrow lbl">Coverage</span>
          <span className="val">
            82.4% <span className="delta up">▲ +0.4</span>
          </span>
        </div>
        <div className="item">
          <span className="eyebrow lbl">Open bugs</span>
          <span className="val">
            4 <span className="delta dn">▼ −2</span>
          </span>
        </div>
  ...
  return (
    <div className="card">
      <div className="card-head">
        <h3>Epic Progress</h3>
        <span className="mono-eye" style={{ marginLeft: 'auto' }}>
          8 epics · sorted by activity
        </span>
      </div>
...
function StatusHero() {
  return (
    <div className="card" style={{ marginBottom: 20, padding: 0 }}>
      ...
      >
        <div className="eyebrow" style={{ gridColumn: 1 }}>
          Release health
        </div>
        <div style={{ gridColumn: 1, display: 'flex', alignItems: 'baseline', gap: 12 }}>
          <span className="disp tnum" style={{ fontSize: 56, lineHeight: 1 }}>
            On track
          </span>
          <Chip tone="ok">STABLE</Chip>
        </div>
        <div style={{ gridColumn: '1 / -1', color: 'var(--text-dim)', fontSize: 14, lineHeight: 1.5 }}>
          R1.10 is projected to ship{' '}
          <span className="mono" style={{ color: 'var(--text)' }}>
            Apr 28 ± 2d
          </span>
          , ahead of the 30 Apr deadline. Velocity is steady at{' '}
          <span className="mono" style={{ color: 'var(--text)' }}>
            6.4 stories/wk
          </span>
          ; bug intake has slowed; coverage is rising. Risk:{' '}
          <span style={{ color: 'var(--warn)' }}>Circuit blocked on theme.js fixture</span>.
        </div>
        <div
          style={{
            gridColumn: 2,
        ...
        >
          <div>
            ...
            <div className="disp tnum" style={{ fontSize: 22, marginTop: 2 }}>
              Apr 28
            </div>
          ...
          <div>
            ...
            <div className="disp tnum" style={{ fontSize: 22, marginTop: 2 }}>
              6.4<span style={{ fontSize: 12, color: 'var(--text-mute)', marginLeft: 4 }}>/wk</span>
            </div>
      ...
      >
        <div>
          <div className="eyebrow" style={{ marginBottom: 6 }}>
            Progress · past 14 weeks
          </div>
          <div className="bars" style={{ height: 60 }}>
            {window.DATA.trendWeeks.map((v, i) => (
              <div key={i} className={i > 9 ? 'b alt' : 'b'} style={{ height: v + '%' }} />
            ))}
          </div>
        </div>
        <div>
            ...
            {window.DATA.coverageHeat.map((v, i) => {
              ...
              return (
                <div
                  ...
                  className="cell"
                  style={{
                    background: `color-mix(in oklab, var(--plan-accent) ${Math.round(a * 100)}%, var(--surface-2))`,
                  }}
                />
              );
            })}
    ...
    <div className="card">
      ...
      <div className="card-body col" style={{ justifyContent: 'center', flex: 1 }}>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <span className="mono-eye">Stories shipped</span>
          <span className="disp tnum" style={{ fontSize: 20 }}>
            6
          </span>
        </div>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <span className="mono-eye">PRs merged</span>
          <span className="disp tnum" style={{ fontSize: 20 }}>
            11
          </span>
        </div>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <span className="mono-eye">Bugs opened</span>
          <span className="disp tnum" style={{ fontSize: 20 }}>
            2
          </span>
        </div>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <span className="mono-eye">Bugs fixed</span>
          <span className="disp tnum" style={{ fontSize: 20, color: 'var(--ok)' }}>
            4
          </span>
        </div>
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <span className="mono-eye">AI spend</span>
          <span className="disp tnum" style={{ fontSize: 20 }}>
            $38.20
          </span>
        </div>
      ...
      <div className="grid-epic-kpi">
        ...
        <div className="card">
          ...
          <div className="card-body col" style={{ justifyContent: 'center', flex: 1 }}>
            <div>
              <div className="row">
                <Chip tone="risk">HIGH</Chip>
                <span style={{ fontSize: 13 }}>Coverage fixture missing</span>
              </div>
              <div style={{ marginTop: 6, fontSize: 12, color: 'var(--text-dim)' }}>
                Blocks US-0134 · Circuit agent · est. 4h to unblock
              </div>
            </div>
            <div>
              <div className="row">
                <Chip tone="warn">MED</Chip>
                <span style={{ fontSize: 13 }}>Stakeholder view unstarted</span>
              </div>
              <div style={{ marginTop: 6, fontSize: 12, color: 'var(--text-dim)' }}>
                EPIC-0012 at 30% · 3 stories unassigned
              </div>
            </div>
            <div>
              <div className="row">
                <Chip tone="info">LOW</Chip>
                <span style={{ fontSize: 13 }}>Font license review pending</span>
              </div>
        ...
        <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 20, alignItems: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', rowGap: 14, columnGap: 12 }}>
              <div>
                ...
                <div className="disp tnum" style={{ fontSize: 22, color: 'var(--ok)' }}>
                  312
                </div>
              </div>
              <div>
                <div className="eyebrow">Failed</div>
                <div className="disp tnum" style={{ fontSize: 22 }}>
                  0
                </div>
              </div>
              <div>
                <div className="eyebrow">Skipped</div>
                <div className="disp tnum" style={{ fontSize: 22, color: 'var(--text-mute)' }}>
                  4
                </div>
              </div>
              <div>
                <div className="eyebrow">Open bugs</div>
                <div className="disp tnum" style={{ fontSize: 22, color: 'var(--warn)' }}>
                  4
                </div>
              </div>
            </div>
          ...
          <div style={{ borderTop: '1px solid var(--border-soft)', paddingTop: 14 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 8 }}>
              ...
              <span className="mono-eye" style={{ color: 'var(--ok)' }}>
                100.0%
              </span>
            </div>
            <div
              style={{ display: 'grid', gridTemplateColumns: 'repeat(14, 1fr)', gap: 3, height: 36, alignItems: 'end' }}
            >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
              {[
                ...
                <div
                  ...
                  style={{
                    display: 'grid',
                    gridTemplateColumns: '88px 1fr 1fr 38px 44px',
                    gap: 10,
                    alignItems: 'center',
                  }}
                >
                  ...
                  <span className="mono tnum" style={{ fontSize: 11, textAlign: 'right' }}>
                    {e.cov}%
                  </span>
                  <span
                    className="mono tnum"
                    style={{
                      fontSize: 10.5,
                      textAlign: 'right',
                      color: e.d.startsWith('\u2013') ? 'var(--risk)' : 'var(--text-mute)',
                    }}
                  >
                    {e.d}
                  </span>
          ...
          {[
            ...
            return (
              <div
                ...
                style={{
                  display: 'grid',
                  gridTemplateColumns: '8px 78px 1fr 40px 34px',
                  gap: 10,
                  alignItems: 'center',
                }}
              >
                ...
                <div style={{ minWidth: 0 }}>
                  <div className="disp" style={{ fontSize: 12.5, lineHeight: 1 }}>
                    {a.n}
                  </div>
                  <div
                    className="mono"
                ...
                <span
                  style={{ height: 6, background: 'var(--surface-2)', borderRadius: 4, overflow: 'hidden' }}
                  title={`${a.pct}% busy`}
                >
                  <span style={{ display: 'block', height: '100%', width: a.pct + '%', background: bar }} />
                </span>
                <span className="mono tnum" style={{ fontSize: 11, color: 'var(--text-dim)', textAlign: 'right' }}>
                  {a.pct}%
                </span>
                <span
                  className="mono tnum"
                  style={{ fontSize: 11, color: 'var(--text)', textAlign: 'right' }}
                  title="Open tasks"
                >
                  {a.c}
                  <span style={{ color: 'var(--text-mute)', marginLeft: 2 }}>t</span>
                </span>
              </div>
            );
          })}
            ...
            {c.items.map((it) => (
              <div className="kcard" key={it.id} data-epic={it.epic}>
                <div className="row" style={{ justifyContent: 'space-between' }}>
                  ...
                  <Chip tone={c.id === 'blocked' ? 'risk' : c.id === 'inprog' ? 'info' : 'mute'}>
                    EPIC-{String(it.epic).padStart(4, '0')}
                  </Chip>
                </div>
  ...
  return (
    <div className="card" style={{ padding: '42px 28px', display: 'grid', placeItems: 'center' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="disp" style={{ fontSize: 32, marginTop: 8 }}>
          {name}
        </div>
        <div style={{ color: 'var(--text-dim)', fontSize: 13, marginTop: 8, maxWidth: 480 }}>
          This tab would adopt the same editorial masthead, shared KPI row, and chart palette — no more mismatched chart
          legends or orphan color systems.
        </div>
      </div>
    </div>
  );
