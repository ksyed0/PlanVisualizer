...
window.DATA = {
  ...
  tool: {
    ...
    mission:
      'A self-documenting dashboard pair for agentic SDLC platforms. Plan-Status is the editorial report; Pipeline is live mission control. Both read from the same JSON fixtures and roster.',
  },
  ...
  kpis: [
    ...
    },
    {
      ...
      big: '82.4',
      unit: '%',
      foot: 'Statements · last run 14:12',
      trend: 'up',
      delta: '+0.4% wk',
    },
  ...
  agents: [
    ...
    },
    {
      ...
      role: 'Product Owner',
      status: 'active',
      task: 'Refining EPIC-0020 ACs',
      count: '12 stories',
      branch: 'spec/EPIC-0020-redesign',
    },
    { name: 'Keystone', role: 'Architect', status: 'idle', task: '—', count: '—', branch: null },
    {
      ...
      role: 'Code Reviewer',
      status: 'review',
      task: 'Reviewing PR #413',
      count: '3 queued',
      branch: 'feat/US-0132-masthead',
    },
    {
      name: 'Palette',
      role: 'UI Designer',
      status: 'active',
      task: 'Redesign canvas v3',
      count: 'US-0135',
      branch: 'feat/US-0135-redesign-canvas',
    },
    { name: 'Forge', role: 'Backend', status: 'idle', task: '—', count: '—', branch: null },
    {
      ...
      role: 'Frontend',
      status: 'active',
      task: 'CD-Redesign scaffold',
      count: 'US-0137',
      branch: 'feat/US-0137-cd-redesign',
    },
    { name: 'Sentinel', role: 'QA / Tests', status: 'idle', task: 'Standby', count: '312 / 312', branch: null },
    {
      ...
      count: '82.4%',
      branch: 'fix/US-0134-coverage-fixture',
    },
  ],
  ...
  kanban: {
    todo: [
      { id: 'US-0137', epic: 20, title: 'Shared theme.js tokens for cross-dashboard reuse' },
      { id: 'US-0138', epic: 20, title: 'Mode badge (REPORT / LIVE) in global chrome' },
    ],
    planned: [
      { id: 'US-0139', epic: 20, title: 'Redesign Status tab with hero + forecast' },
    ...
    inprog: [
      { id: 'US-0135', epic: 20, title: 'Replace navy header with editorial masthead' },
